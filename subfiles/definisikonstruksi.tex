...
\label{sub:Jenis Penyaluran Beban Struktur}
...
\label{sub:Peran Struktur Bangunan}
...
\begin{table}[htb]
	...
	\label{tb:sejarahrancang}
	\begin{tabularx}{.89\textwidth}{llll}
		\hline
		No.                                                                    &  Peradaban                              &  Bangunan ikonik                                                                                            &  Fungsi  \\
		1                                                                      &  Prasejarah                             &  Gua, Gubuk                                                                                                 &  Perlindungan dari
		cuaca dan binatang buas.  \\
		2                                                                      &  Peradaban Kuno                         &  Mesir Piramida                                                                                             &  Sebagai makamraja dengan teknik konstruksi batu monumental.  \\
		                                                                       &                                         &  Mesopotamia: Ziggurat                                                                                      &  simbol arsitektur religius dengan bentuk bertingkat.  \\
		                                                                       &                                         &  Yunani Kuno: Parthenon.                                                                                    &  Penggunaan kolom dalam arsitektur seperti Doric, Ionic, dan Corinthian  \\
		                                                                       &                                         &  Romawi Colosseum                                                                                           &  Perkembangan teknik seperti kubah (dome), lengkungan (arch), dan beton (concrete).  \\
		3                                                                      &  Abad pertengahan                       &  Bangunan gereja
		dan kastil dengan dinding tebal, jendela kecil, dan bentuk melingkar.  &  Gaya Romantik  \\
		                                                                       &                                         &  Katedral dengan atap tinggi, jendela kaca patri besar, dan lengkungan runcing, seperti Katedral NotreDame  &  Gaya Gotik  \\

		4                                                                      &  Abad Pencerahan dan Revolusi Industri  &  Jembatan, Gedung Pabrik                                                                                    &  Bangunan mulai mengadopsi bentuk yang lebih fungsional. Kemajuan teknologi memungkinkan bahan seperti besi dan baja digunakan dalam konstruksi.  \\
		5                                                                      &  Abad ke-20 (modernisme)                &  Gedung besar di kota                                                                                       &  Dominasi gedung pencakar langit dengan struktur kaca dan baja  \\
		6                                                                      &  Abad ke-21 (Kontemporer)               &  gedung pintar dan ramah lingkungan.                                                                        &  Fokus pada keberlanjutan (sustainability) dan teknologi canggih. Arsitektur eksperimental dengan bentuk dan material inovatif, seperti penggunaan bahan daur ulang.  \\
	\end{tabularx}
\end{table}

\subsection{Dasar Konstruksi Bangunan}%
\label{sub:Dasar Konstruksi Bangunan}
...
\label{ssub:Jenis-jenis beban yang diterima dan disalurkan pada

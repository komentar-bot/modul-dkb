...
\begin{enumerate}
	...
	\item[] Bagian beton yang rusak dipotong dan diganti dengan campuran beton baru.
	\item Penguatan Tulangan
	\item[] Menambah atau memperkuat tulangan baja untuk meningkatkan kapasitas struktur dalam menahan beban.
	\item Penggunaan Fiber Reinforced Polymer (FRP)
	\item[]Material ini digunakan untuk memperkuat elemen struktural tanpa menambah beban tambahan yang signifikan
	\item Penggunaan Material perbaikan
\end{enumerate}

\tabitems Grouting: Injeksi bahan cair seperti mortar ke dalam retak atau rongga untuk mengisi dan memperbaiki kerusakan
\tabitems Epoxy ijection: Teknologi ini digunakan untuk memperbaiki retak halus dengan cara menyuntikkan epoxy resin yang kuat dan tahan air.
\tabitems Cementitious Materials: Penggunaan bahan berbasis semen untuk menggantikan atau memperbaiki area yang terkelupas atau keropos.

\begin{enumerate}[resume]
	\item Teknik Perbaikan struktur beton
	\item[] Teknik perbaikan struktur beton mencakup beberapa metode yang efektif untuk mengembalikan kekuatan dan fungsi struktur yang telah mengalami kerusakan. Salah satunya adalah patching, yang dilakukan dengan menambal bagian beton yang rusak menggunakan material perbaikan seperti mortar atau campuran beton. Metode ini umum digunakan untuk memperbaiki permukaan beton yang terkelupas atau mengalami keretakan ringan. Retrofitting juga menjadi pilihan untuk memperkuat struktur yang sudah ada, dengan menambahkan elemen atau material baru untuk meningkatkan kapasitas struktur dalam menahan beban tambahan atau kondisi lingkungan yang berubah. Retrofitting sering kali dilakukan pada bangunan yang telah berusia lama, atau pada struktur yang perlu disesuaikan dengan peraturan dan standar baru. Selain itu, teknik shotcrete merupakan metode yang efisien dan cepat untuk perbaikan struktur beton, di mana beton atau mortar disemprotkan ke permukaan dengan tekanan tinggi. Shotcrete digunakan untuk memperbaiki kerusakan besar atau untuk aplikasi beton pada area yang sulit dijangkau, seperti pada struktur vertikal atau langit-langit. Metode ini memungkinkan aplikasi yang lebih padat dan kuat dalam waktu yang relatif singkat, sekaligus mengurangi waktu pemeliharaan. Ketiga teknik ini, baik secara individu atau kombinasi, menawarkan solusi perbaikan yang handal dan dapat disesuaikan dengan kondisi kerusakan beton yang berbeda-beda.
\end{enumerate}

\subsection{Arah Pengembangan Teknologi Beton di Masa Depan}%
\label{sub:Arah Pengembangan Teknologi Beton di Masa Depan}

Masa depan teknologi beton berfokus pada inovasi yang mendukung efisiensi, keberlanjutan, dan adaptasi terhadap kebutuhan zaman. Salah satu arah pengembangan utama adalah integrasi teknologi digital, seperti Building Information Modeling (BIM), yang memungkinkan desain dan pengelolaan struktur beton dilakukan dengan lebih efisien dan akurat. Selain itu, hadirnya beton pintar (smart concrete) yang dilengkapi sensor mampu memantau kondisi struktur secara real-time, seperti retak atau deformasi. Teknologi ini tidak hanya membantu dalam pemeliharaan preventif tetapi juga memperpanjang masa pakai bangunan, meningkatkan keandalan struktur beton dalam jangka panjang. Beton untuk bangunan berkelanjutan mengutamakan efisiensi energi dan keberlanjutan dalam konstruksi. Teknologi seperti beton dengan insulasi termal tinggi atau beton permeabel yang memungkinkan air hujan terserap ke dalam tanah adalah contoh konkret dari inovasi ini. Beton jenis ini sering digunakan dalam proyek hijau yang memprioritaskan lingkungan, seperti LEED (Leadership in Energy and Environmental Design)

Di sisi lain, keberlanjutan menjadi fokus penting dalam pengembangan beton di masa depan. Penelitian terus dilakukan untuk menemukan bahan alternatif pengganti semen yang lebih ramah lingkungan, seperti beton karbon-negatif atau bio-concrete, yang dapat mengurangi emisi karbon dalam proses produksinya. Teknologi robotika dan pencetakan 3D untuk beton juga membuka peluang besar untuk menciptakan desain yang lebih kompleks dan unik, sekaligus mempercepat proses konstruksi dengan presisi tinggi. Dengan inovasi-inovasi ini, beton masa depan akan menjadi solusi yang tidak hanya kokoh dan efisien tetapi juga mendukung keberlanjutan lingkungan dan kebutuhan konstruksi modern.

\subsection{Kesimpulan}%
\label{sub:Kesimpulan}

Beton, sebagai material utama dalam banyak proyek konstruksi, memiliki potensi yang sangat besar dalam mendukung infrastruktur yang tahan lama dan ramah lingkungan. Teknologi beton telah berkembang pesat, membawa berbagai inovasi yang memperkaya dunia konstruksi dan memberikan solusi yang lebih efisien, kuat, dan ramah lingkungan. Dari beton bertulang yang banyak digunakan dalam konstruksi gedung, hingga beton pratekan yang meningkatkan kapasitas struktural, setiap jenis beton menawarkan keunggulan tertentu yang disesuaikan dengan kebutuhan proyek. Di sisi lain, tantangan terbesar dalam dunia konstruksi beton tetap berfokus pada ketahanan terhadap pengaruh lingkungan dan kerusakan akibat usia dan penggunaan. Oleh karena itu, pemeliharaan yang tepat dan teknologi perbaikan yang mutakhir sangat penting untuk memastikan bahwa struktur beton dapat terus berfungsi secara optimal dan aman. Dengan integrasi teknologi digital, pengembangan bahan ramah lingkungan, dan pemanfaatan teknik konstruksi modern, beton tidak hanya akan tetap menjadi material konstruksi utama, tetapi juga akan beradaptasi dengan kebutuhan zaman yang semakin kompleks dan berorientasi pada keberlanjutan. Seiring dengan perkembangan ini, beton akan terus menjadi tulang punggung infrastruktur global yang lebih kuat, lebih efisien, dan lebih ramah lingkungan.
